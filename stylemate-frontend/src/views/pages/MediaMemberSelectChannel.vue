          ...
          <ul class="addChannel">
            <li class="addedmember">
              ...
              <div class="newChannel">
                ...
                <div>
                  <button class="channelBtn" type="button">확인중</button>
                </div>
              </div>
              <div class="newChannel">
                <div class="channelLeft">
                ...
                <div>
                  <button class="channelBtn" type="button">-</button>
                </div>
              </div>
            </li>
            <li>
           ...
           <div class="subscribe-wrap">
            <button class="black-btn">관리자가 승인하면 협찬활동이 가능합니다.</button>
          </div>
          <div class="subscribe-wrap" v-if="replyseen">
            <button class="black-btn">15일이 지난 후에 재신청이 가능합니다.</button>
          </div>
        </div>
    </ion-content>
    <!-- End page content -->
...
.channelLeft .channelDec h4{
  font-size: 14px;
  font-weight: 700;
  line-height: 150%;
  margin-bottom: 10px;
}
.channelLeft .channelDec p{
  font-size: 12px;
  font-weight: 400;
  line-height: 150%;
}
.newChannel .channelBtn{
  border: 1px solid #797979;
  color: #797979;
  padding: 5px 30px;
  border-radius: 20px;
